...
coinsIcon.src = "${window.location.origin}/games-main";
...
function getCoinsAndUpdateUI(walletAddress) {
  var apiUrl = "${window.location.origin}/api/coin-system/";
...
function checkTokenAndAddress(walletaddress, token) {
  return new Promise((resolve, reject) => {
    // Endpoint URL
    const url = "${window.location.origin}/api/captcha-system/validate"; // Replace with your actual PHP endpoint URL

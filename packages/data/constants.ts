...
export const IS_PRODUCTION =
  typeof window !== "undefined"
    ? (window as any).VITE_IS_PRODUCTION === "true"
    : false;

// Lens and Hey Env Config
export const LENS_NETWORK =
  typeof window !== "undefined"
    ? (window as any).NEXT_PUBLIC_LENS_NETWORK || "testnet"
    : "testnet";
...
// In development default to local API unless VITE_API_URL is set
...
export const LIVEPEER_KEY =
  typeof window !== "undefined" ? (window as any).LIVEPEER_KEY : undefined;

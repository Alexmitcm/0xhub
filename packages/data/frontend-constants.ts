...
// Note: avoid Vite-specific types here; use process.env for shared package
...
// Environments
export const IS_PRODUCTION = env.VITE_IS_PRODUCTION === "true";

// Lens and Hey Env Config
export const LENS_NETWORK = env.NEXT_PUBLIC_LENS_NETWORK || "testnet";
...
export const LIVEPEER_KEY = env.LIVEPEER_KEY;

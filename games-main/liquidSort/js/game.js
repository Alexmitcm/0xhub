...
// var shareEnable = true; // Removed unused variable //toggle share
 ...
 *
 */
// function updateGame() { // Removed unused function
if (!gameData.paused) {
  if (timeData.enable) {
...
function updateTimer() {
  ...
  function calculateScore() {
    ...
    TweenMax.to(timeData, 1, {
      onComplete: () => {
        ...
        totalScore = Math.ceil(totalScore / 100);
        playerData.score += Math.ceil(totalScore / 100);
        ...
        if (!isError) {
          ...
          formData.append("amount", Math.ceil(totalScore));
          fetch(apiUrl, {
            body: formData,
            method: "POST"
          })
  ...
  function updateGameLevel() {
    levelTxt.text = textDisplay.level.replace(
      "[NUMBER]",
      gameData.challengeNum
    );
  }
   ...
   *
   */
  // function millisecondsToTimeGame(milli) { // Removed unused function
  // var milliseconds = milli % 1000; // Removed unused variable
   ...
   *
   */
  // function share(action) { // Removed unused function
